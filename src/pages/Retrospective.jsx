...
const FEELINGS = [
	...
	},
	{
		...
		body: "급하게 개발하다 보니 주석을 나만 알아볼 수 있게 쓴 곳이 많았습니다. \n  나중에 팀원이 내 코드를 봐야 할 때, 또 시간이 지나 내가 다시 볼 때 그 주석이 오히려 걸림돌이 됐습니다. \n  주석은 나를 위한 메모가 아니라 함께 일하는 사람을 위한 것이라는 걸 느꼈고, 누가 봐도 이해되는 코드를 쓰는 연습을 이어가려 합니다.",
	},
];
