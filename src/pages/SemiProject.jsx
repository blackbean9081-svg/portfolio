			...
			<div className="pay2">
				...
				<div className="pay2__right">
					...
					<Func
						...
						desc={
							"PM 권한과 필수값, 날짜를 검증한 뒤,\n프로젝트, 부서, 일정, 담당자 4개 테이블 INSERT를 하나의 트랜잭션으로 묶어 하나라도 실패하면 전부 롤백합니다."
						}
						file="ProjService.java"
						code={CODE_INSERT}
						retro={
							"프로젝트, 부서, 일정, 담당자 4개 테이블을 하나의 트랜잭션으로 처리했습니다. 중간에 하나라도 실패하면 전체가 함께 롤백되도록 해, 데이터가 일부만 저장되는 상황을 막았습니다."
						}
					/>
					<Func
						rich
						...
						code={CODE_UPDATE}
						retro={
							"생성과 동일하게 4개 테이블을 한 트랜잭션으로 수정했습니다. 담당자는 기존 여부에 따라 수정 또는 추가로 나눠 처리해, 담당자가 바뀌어도 데이터가 어긋나지 않게 했습니다."
						}
					/>
					<Func
						rich
